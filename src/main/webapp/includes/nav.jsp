<img src="${pageContext.request.contextPath}/assets/logo/giga_logo.png" />
<div class="__nav-link">
    <img class="__nav-icons" src="${pageContext.request.contextPath}/assets/icons/dashboard.png" />
    <a href="<%= request.getContextPath() %>/admin">Dashboard</a>
</div>
<div class="__nav-link">
    <img class="__nav-icons" src="${pageContext.request.contextPath}/assets/icons/products.png " />
